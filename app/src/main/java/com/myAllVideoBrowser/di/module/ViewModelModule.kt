...
import com.myAllVideoBrowser.ui.main.migration.MigrationCenterViewModel
...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(MigrationCenterViewModel::class)
    abstract fun bindMigrationCenterViewModel(viewModel: MigrationCenterViewModel): ViewModel
}
