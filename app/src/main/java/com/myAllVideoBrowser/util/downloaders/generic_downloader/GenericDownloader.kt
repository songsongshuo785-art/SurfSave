...
abstract class GenericDownloader {
    companion object {
        ...
        fun isWorkScheduled(context: Context, uniqueWorkName: String): Boolean {
            ...
            try {
                ...
                AppLogger.e("isWorkScheduled: Error checking work status for $uniqueWorkName", e)
    ...
    class Constants {
        companion object {
            ...
            const val EXECUTION_TOKEN_KEY = "EXECUTION_TOKEN"
            const val EXECUTION_KEY = "EXECUTION_KEY"
    ...
    class DownloaderActions {
        companion object {
            ...
            const val RECOVER_FINALIZATION = "RECOVER_FINALIZATION"
        }
    }
    ...
    open fun runWorkerTask(context: Context, info: VideoInfo, taskData: OneTimeWorkRequest) {
        ...
        try {
            ...
            AppLogger.e("GenericDownloader: cancelAllWork failed for ${info.id}", e)
        } finally {
