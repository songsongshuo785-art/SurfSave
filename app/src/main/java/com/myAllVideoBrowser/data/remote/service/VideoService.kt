        ...
        try {
            ...
            if (formatsArray != null) {
                for (i in 0 until formatsArray.length()) {
                    ...
                    val entity = VideoFormatEntity(
                        ...
                        fileSizeApproximate = f.optLong("filesize_approx", 0L),
            ...
            return VideoInfoWrapper(
                VideoInfo(
                    ...
                    downloadUrls = if (isM3u8OrMpd) emptyList() else listOf(url.toDownloadRequestData())
            ...
            CookieUtils.deleteTemporaryCookieFile(tmpCookieFile)
        }
    }
